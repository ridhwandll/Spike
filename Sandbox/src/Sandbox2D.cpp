...
void Sandbox2D::OnAttach()
{
    ...
    LightEngine::FramebufferSpecification fbSpec;
    fbSpec.Width = 1280;
    fbSpec.Height = 780;
    m_Framebuffer = LightEngine::Framebuffer::Create(fbSpec);
}
    ...
    if (dockingEnabled)
    {
        ...
        if (ImGui::BeginMenuBar())
        {
            if (ImGui::BeginMenu("File"))
            {
                ...
                if (ImGui::MenuItem("Exit")) LightEngine::Application::Get().Close();
                ImGui::EndMenu();
            }
