...
namespace Spike::Scripting
{
    ...
    {
        SPK_CORE_LOG_INFO(ConvertMonoStringToCppString(message));
    ...
    {
        SPK_CORE_LOG_WARN(ConvertMonoStringToCppString(message));
    ...
    {
        SPK_CORE_LOG_DEBUG(ConvertMonoStringToCppString(message));
    ...
    {
        SPK_CORE_LOG_ERROR(ConvertMonoStringToCppString(message));
    ...
    {
        SPK_CORE_LOG_CRITICAL(ConvertMonoStringToCppString(message));
