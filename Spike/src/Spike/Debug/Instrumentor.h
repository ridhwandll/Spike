...
#define LE_PROFILE_BEGIN_SESSION(name, filepath) ::Spike::Instrumentor::Get().BeginSession(name, filepath)
#define LE_PROFILE_END_SESSION() ::Spike::Instrumentor::Get().EndSession()
#define LE_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Spike::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
                                               ::Spike::InstrumentationTimer timer##line(fixedName##line.Data)
